---
layout: post
title: Coral Airbrushing Protocol
date: '2024-10-16'
...
#### This protocol was adapted and modified from [Hollie Putnam](https://hputnam.github.io/Putnam_Lab_Notebook/Coral_Tissue_Removal_protocol/) for the Putnam Lab, [Emma Strand](https://github.com/emmastrand/EmmaStrand_Notebook/blob/master/_posts/2019-10-22-Airbrushing-Protocol.md) and [Jill Ashey](https://github.com/JillAshey/JillAshey_Putnam_Lab_Notebook/blob/master/_posts/2022-03-20-Clipping-Airbrushing.md).
---
...
- Never touch the fragment with your fingers
...
1. <a name="Materials"></a> **Materials**
	...
	- Foil
	- Forceps
	- Coolers w/ dry ice (or normal ice if samples from -80 ºC)
...
2. <a name="Set-Up"></a> **Set-Up**
	...
	7. Collect necessary tubes and ziplock bags, and label for each sample. Label each tube with the specific assay that it will be used for. The following is needed for each sample:
		...
		- one 2 mL tube foe carbohydrates 
...
3. <a name="Airbrushing-Protocol"></a> **Airbrushing Protocol**
	...
	10. From the 50 mL falcon tube: 
		...
		- Aliquot 1 mL of tissue homogenate into the "Carb" tube, place tube in freezer in labelled box.
		- Aliquot 1 mL of tissue homogenate into the "Lipid" tube, place tube in freezer in labelled box.
		- Aliquot 5 mL of tissue homogenate into the "AFDW" tube, place tube in freezer in labelled box
		- Keep rest in 50 mL at -80 ºC
	11. Bleach skeleton fragment in 20% bleach in a labelled tupperware container (label BLEACH so it is not used for larvae/live coral) for 24 hours. After 24 hours, use sterilized tweezers to remove the skeleton and place on a paper towel labeled with the sample ID. Let dry for 24 hours. 
	12. Continue with the wax dipping protocol.
